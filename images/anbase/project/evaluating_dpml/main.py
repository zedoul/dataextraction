...
def run_experiment(args):
    ...
    if args.target_privacy == 'no_privacy':
        pickle.dump([train_acc, test_acc, train_loss, membership, shokri_mem_adv, shokri_mem_confidence, yeom_mem_adv, per_instance_loss, yeom_attr_adv, pred_membership_all, features], open(RESULT_PATH+args.train_dataset+'/'+args.target_model+'_no_privacy_'+str(args.l2_ratio)+'.p', 'wb'))
    else:
